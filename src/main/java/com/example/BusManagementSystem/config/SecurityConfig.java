...
import com.example.BusManagementSystem.security.CustomOAuth2UserService;
import com.example.BusManagementSystem.security.JwtAuthenticationFilter;
import com.example.BusManagementSystem.security.OAuth2FailureHandler;
import com.example.BusManagementSystem.security.OAuth2SuccessHandler;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("DELETE", "/api/buses/**").hasRole("ADMIN")
                        .requestMatchers("DELETE", "/api/driver/**").hasRole("ADMIN")
                        .requestMatchers("DELETE", "/api/passenger/**").hasRole("ADMIN")
                        ...
                        .requestMatchers("PUT", "/api/buses/**").hasRole("ADMIN")
                        .requestMatchers("POST", "/api/buses/**").hasRole("ADMIN")
